            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(shape: BoxShape.circle, color: AppColors.onPrimaryBorder),
                  child: CircleAvatar(radius: 28, backgroundImage: AssetImage('lib/core/assets/images/avatar_1.png')),
                ),
                SizedBox(width: 12.0),
