...
import 'package:flutter_math_app/features/scenes/presentation/practice_game/widgets/practice_fab.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      ...
      child: Scaffold(
        ...
        floatingActionButton: PracticeFloatingActionButtons(),
      ),
    );
  }
}
