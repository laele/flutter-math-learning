...
class ArcadeGameScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => sl<GameCubit>(param1: ArcadeRulesPolicy())),
      ...
      child: ArcadeGameView(),
    );
  }
}

class ArcadeGameView extends StatefulWidget {
  const ArcadeGameView({super.key});

  @override
  State<ArcadeGameView> createState() => _ArcadeGameViewState();
}

class _ArcadeGameViewState extends State<ArcadeGameView> {
