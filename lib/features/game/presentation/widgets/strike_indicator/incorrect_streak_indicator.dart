...
import 'package:flutter_math_app/features/scenes/presentation/practice_game/widgets/incorrect_streak_animated.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<GameCubit, GameState>(
      listenWhen: (previous, current) {
        if (previous.gameSession.incorrectStreak != current.gameSession.incorrectStreak) {
          return true;
        }
        return false;
      },
